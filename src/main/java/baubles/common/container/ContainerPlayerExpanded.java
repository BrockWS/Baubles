...
public class ContainerPlayerExpanded extends Container {
    ...
    public ContainerPlayerExpanded(InventoryPlayer playerInv, boolean par2, EntityPlayer player) {
        ...
        baubles = player.getCapability(BaublesCapabilities.CAPABILITY_BAUBLES, null).orElseThrow(() -> new NullPointerException("Player is missing Baubles Capability!"));
        ...
        for (int k = 0; k < 4; k++) {
            ...
            this.addSlot(new Slot(playerInv, 36 + (3 - k), 8, 8 + k * 18) {
                ...
                public String getSlotTexture() {
                    return ContainerPlayer.field_200829_h[slot.getIndex()];
                }
            });
        }
